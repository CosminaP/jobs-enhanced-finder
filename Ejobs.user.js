...
window.onload = function () {
	var buttonFilter = $("<button>Filtreaza Joburi</button>").css({"font-size" : "14px" , "color" : "#FFF" , "background-color" : "transparent","width": "130px","border": "none","font-family": "Roboto, Arial, sans-serif","padding": "13px 0 0 5px"}).click(filterJobs);
